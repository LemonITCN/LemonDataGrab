...
# Generation Time: 2016-07-04 09:55:09 +0000
# ************************************************************
...
VALUES
	...
	(6,'d613cf47-5a0b-4d10-9bd5-f9cc11e98158','2f6eccd5-7527-42d3-9576-dbb0a7e7d06b','Mac OS X 10.11.5',1,'liuris-MacBook-Pro.local','1.0',1466575607),
	(7,'94a7c798-989f-4049-9c43-bea73e529f23','0b572a38-86ec-40df-86ca-6b11354118e6','Mac OS X 10.11.5',1,'liuris-MacBook-Pro.local','1.0',1466637727);

/*!40000 ALTER TABLE `ldg_client` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ldg_errorResult
# ------------------------------------------------------------
...
VALUES
	...
	(7,'beda6372-0acf-45c8-bc4c-8b81fbb1a645',7,2,1466637727,1466637727,0),
	(11,'bc0d3717-f56d-4268-b9be-23a87461cb28',6,2,1466836936,1466836936,0),
	(13,'63649009-d726-44ee-8fec-bc972c46acf3',7,3,1467462743,1467462743,0);
...
LOCK TABLES `ldg_task` WRITE;
/*!40000 ALTER TABLE `ldg_task` DISABLE KEYS */;

INSERT INTO `ldg_task` (`task_id`, `task_name`, `task_fingerprint`, `task_description`, `task_createTime`, `task_publishTime`, `task_distributeRepeatInterval`, `task_distributeRepeatCount`, `task_distributedNumber`, `task_executeScript`, `task_loadUrlTimeout`, `task_state`, `task_theTop`, `task_expired`)
VALUES
	(57,'测试任务','312eff5d-6a27-4bac-b81f-bf4d499e5a60_0','这是一个测试任务',1467421773,1467444600,86400,9,0,'console.log(\"successful\");',20,4,0,0),
	(58,'测试任务','312eff5d-6a27-4bac-b81f-bf4d499e5a60_1','这是一个测试任务',1467421773,1467531000,86400,9,1,'console.log(\"successful\");',20,0,0,0),
	(59,'测试任务','312eff5d-6a27-4bac-b81f-bf4d499e5a60_2','这是一个测试任务',1467421773,1467617400,86400,9,2,'console.log(\"successful\");',20,0,0,0),
	(60,'测试任务','312eff5d-6a27-4bac-b81f-bf4d499e5a60_3','这是一个测试任务',1467421773,1467703800,86400,9,3,'console.log(\"successful\");',20,0,0,0),
	(61,'测试任务','312eff5d-6a27-4bac-b81f-bf4d499e5a60_4','这是一个测试任务',1467421773,1467790200,86400,9,4,'console.log(\"successful\");',20,0,0,0),
	(62,'测试任务','312eff5d-6a27-4bac-b81f-bf4d499e5a60_5','这是一个测试任务',1467421773,1467876600,86400,9,5,'console.log(\"successful\");',20,0,0,0),
	(63,'测试任务','312eff5d-6a27-4bac-b81f-bf4d499e5a60_6','这是一个测试任务',1467421773,1467963000,86400,9,6,'console.log(\"successful\");',20,0,0,0),
	(64,'测试任务','312eff5d-6a27-4bac-b81f-bf4d499e5a60_7','这是一个测试任务',1467421773,1468049400,86400,9,7,'console.log(\"successful\");',20,0,0,0),
	(65,'测试任务','312eff5d-6a27-4bac-b81f-bf4d499e5a60_8','这是一个测试任务',1467421773,1468135800,86400,9,8,'console.log(\"successful\");',20,0,0,0),
	(66,'测试任务','312eff5d-6a27-4bac-b81f-bf4d499e5a60_9','这是一个测试任务',1467421773,1468222200,86400,9,9,'console.log(\"successful\");',20,0,0,0),
	(67,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_0','任务简单的说明哦',1467463809,1467466200,21600,20,0,'console.log(\'ts\');',20,0,0,7200),
	(68,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_1','任务简单的说明哦',1467463809,1467487800,21600,20,1,'console.log(\'ts\');',20,0,0,7200),
	(69,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_2','任务简单的说明哦',1467463809,1467509400,21600,20,2,'console.log(\'ts\');',20,0,0,7200),
	(70,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_3','任务简单的说明哦',1467463809,1467531000,21600,20,3,'console.log(\'ts\');',20,0,0,7200),
	(71,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_4','任务简单的说明哦',1467463809,1467552600,21600,20,4,'console.log(\'ts\');',20,0,0,7200),
	(72,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_5','任务简单的说明哦',1467463809,1467574200,21600,20,5,'console.log(\'ts\');',20,0,0,7200),
	(73,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_6','任务简单的说明哦',1467463809,1467595800,21600,20,6,'console.log(\'ts\');',20,0,0,7200),
	(74,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_7','任务简单的说明哦',1467463809,1467617400,21600,20,7,'console.log(\'ts\');',20,0,0,7200),
	(75,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_8','任务简单的说明哦',1467463809,1467639000,21600,20,8,'console.log(\'ts\');',20,0,0,7200),
	(76,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_9','任务简单的说明哦',1467463809,1467660600,21600,20,9,'console.log(\'ts\');',20,0,0,7200),
	(77,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_10','任务简单的说明哦',1467463809,1467682200,21600,20,10,'console.log(\'ts\');',20,0,0,7200),
	(78,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_11','任务简单的说明哦',1467463809,1467703800,21600,20,11,'console.log(\'ts\');',20,0,0,7200),
	(79,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_12','任务简单的说明哦',1467463809,1467725400,21600,20,12,'console.log(\'ts\');',20,0,0,7200),
	(80,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_13','任务简单的说明哦',1467463809,1467747000,21600,20,13,'console.log(\'ts\');',20,0,0,7200),
	(81,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_14','任务简单的说明哦',1467463809,1467768600,21600,20,14,'console.log(\'ts\');',20,0,0,7200),
	(82,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_15','任务简单的说明哦',1467463809,1467790200,21600,20,15,'console.log(\'ts\');',20,0,0,7200),
	(83,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_16','任务简单的说明哦',1467463809,1467811800,21600,20,16,'console.log(\'ts\');',20,0,0,7200),
	(84,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_17','任务简单的说明哦',1467463809,1467833400,21600,20,17,'console.log(\'ts\');',20,0,0,7200),
	(85,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_18','任务简单的说明哦',1467463809,1467855000,21600,20,18,'console.log(\'ts\');',20,0,0,7200),
	(86,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_19','任务简单的说明哦',1467463809,1467876600,21600,20,19,'console.log(\'ts\');',20,0,0,7200),
	(87,'测试任务哦','05b1d7bd-543d-4541-b01f-5c3ef6ce0976_20','任务简单的说明哦',1467463809,1467898200,21600,20,20,'console.log(\'ts\');',20,0,0,7200);

/*!40000 ALTER TABLE `ldg_task` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	(2,'liuri@lemonsoft.net','','','æ¥',2,0,'eca7a808bb7bb2bce406900208b1eb5b',1464486539,'9b978ce0-75ba-4d18-936f-549aab3f212b'),
	(3,'liuri1@lemonsoft.net','','','æ¥',2,0,'eca7a808bb7bb2bce406900208b1eb5b',1464486639,'3b8e4361-72e5-488c-9ba7-df12b71c6e65'),
	(4,'liuri2@lemonsoft.net','','','æ¥',1,0,'eca7a808bb7bb2bce406900208b1eb5b',1464486748,'e804c0fb-f2b6-422e-a3bb-f512ba2112bc'),
