...
import net.lemonsoft.DataGrab.service.ClientService;
import net.lemonsoft.DataGrab.tool.*;
            ...
            public void run() {
                try {
                    ...
                    if (loginResult.getBoolean("success")) {
                        ...
                        errInfo[0] = "登录失败." + loginResult.getString("info");
