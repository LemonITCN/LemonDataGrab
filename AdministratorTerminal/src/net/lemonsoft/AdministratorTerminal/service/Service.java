...
import net.lemonsoft.AdministratorTerminal.dao.Dao;
...
public class Service<T, DT> {
    ...
    public boolean delete(T entity) {
        ...
        } catch (EntityAnnotationIncompleteException e) {
            e.printStackTrace();
            return false;
        }
    }
    ...
    /**
     * 获取带有一个当前会话指纹键值对定的map
     * @return 生成的map对象
     */
    public static HashMap<String , String> getParamsMapWithSessionFingerprint(){
