package net.lemonsoft.LemonDataGrab.dataGrabTerminal.dao;

import net.lemonsoft.LemonDataGrab.dataGrabTerminal.annotation.EntityAnnotation;
import net.lemonsoft.LemonDataGrab.dataGrabTerminal.annotation.EntityPropertyAnnotation;
import net.lemonsoft.LemonDataGrab.dataGrabTerminal.exception.EntityAnnotationIncompleteException;
import net.lemonsoft.LemonDataGrab.dataGrabTerminal.tool.DatabaseTool;
