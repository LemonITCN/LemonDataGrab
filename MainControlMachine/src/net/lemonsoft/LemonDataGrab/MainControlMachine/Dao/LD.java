...
public class LD<T> {
    ...
    public boolean add(T entity) throws IllegalAccessException {
        ...
        for (Field field : fields) {
            LANEntityProperty property = field.getAnnotation(LANEntityProperty.class);
        ...
        return LUDatabase.update(sqlStrBuilder.toString(), values.toArray()) > 0;
    }
     ...
     * @throws LEXEntityAnnotationIncomplete
     */
    public boolean deleteByPrimaryKey(Object key) throws LEXEntityAnnotationIncomplete {
        return this.deleteBySQLCondition(String.format("WHERE %s = ?", this.getPrimaryKeyName()), key) > 0;
    }
    ...
    public int deleteBySQLCondition(String sqlCondition, Object... objects) {
        return LUDatabase.update(String.format("DELETE FROM %s %s", this.getTableName(), sqlCondition), objects);
    }
    ...
    public boolean update(T entity) throws IllegalAccessException {
        ...
        return LUDatabase.update(sqlBuilder.toString(), primaryValue) > 0;
    }
    ...
    public T getByPrimaryKey(Object key) throws Exception {
        ...
        Map<String, Object> result = LUDatabase.query(sqlStr, key).get(0);
    ...
    public String getPrimaryKeyName() {
        Field[] fields = entityClass.getDeclaredFields();
        for (Field field : fields) {
            LANEntityProperty lanEntityProperty = field.getAnnotation(LANEntityProperty.class);
    ...
    public String getSelectSqlPre() throws Exception {
        ...
        if (this.getTableName() == null || this.getPrimaryKeyName() == null || columnsStr.length() <= 0) {
            throw new LEXEntityAnnotationIncomplete();
        }
    ...
    public ArrayList<T> getBySQLCondition(String sqlCondition, Object... objects) throws Exception {
        ArrayList<T> result = new ArrayList();
        List<Map<String, Object>> queryResult = LUDatabase.query(this.getSelectSqlPre() + " " + sqlCondition, objects);
    ...
    public int countBySQLCondition(String sqlCondition, Object... objects) {
        return LUDatabase.count("SELECT COUNT(" + this.getPrimaryKeyName() + ") FROM " + this.getTableName() + " " + sqlCondition, objects);
    }
    ...
    public T initByResultMap(Map<String, Object> resultMap) throws Exception {
        ...
        for (Field field : fields) {
            ...
            Object object = resultMap.get(property.columnName());
    ...
    public String getTableName() {
        return entityClass.getAnnotation(LANEntity.class).tableName();
    }
