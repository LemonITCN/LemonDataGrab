...
import net.lemonsoft.LemonDataGrab.MainControlMachine.Dao.LD;
...
public class LS<T, DT> {
    ...
    public LS() {
        ...
        if (type instanceof ParameterizedType) {
            ...
            try {
                this.dao = (LD) daoClass.newInstance();
    ...
    public boolean delete(T entity) {
        ...
        } catch (LEXEntityAnnotationIncomplete lexEntityAnnotationIncomplete) {
